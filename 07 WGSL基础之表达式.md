...
**WGSL 除了一些常见的通用编程语言的表达式外，还有一些自己独特的表达式。**
...
关于表达式，本文大概过了一遍，如果有不理解的地方，暂时不用去想，等后期 WGSL 代码写多了，自然就明白了。

那么下一篇，我们就开始学习 控制语句，说直白点就是 if、wsitch、while 等。